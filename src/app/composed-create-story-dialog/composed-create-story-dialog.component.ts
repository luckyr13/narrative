...
import { CreateStoryDialogComponent } from '../shared/create-story-dialog/create-story-dialog.component'; 
...
@Component({
  selector: 'app-composed-create-story-dialog',
  templateUrl: './composed-create-story-dialog.component.html',
  styleUrls: ['./composed-create-story-dialog.component.scss']
})
export class ComposedCreateStoryDialogComponent implements OnInit, OnDestroy {
  account = '';
